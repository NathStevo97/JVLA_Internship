...
for ANT_ID in ANT_LIST:
	...
	plt.savefig('/data/jvla/plots/Leakage_tec/'+ANT_ID+'_All_Pols.png', bbox_inches='tight')
	...
	plt.savefig('/data/jvla/plots/Leakage_tec/'+ANT_ID+'_Left.png', bbox_inches='tight')
	...
	plt.savefig('/data/jvla/plots/Leakage_tec/'+ANT_ID+'_Right', bbox_inches='tight')
	plt.clf()
	opacity = 0.8
	w = 1.0
	Left_SPWS = []
	...
	plt.savefig('/data/jvla/plots/Leakage_tec/'+ANT_ID+'_Percentage_Deviation_Comparison')
	plt.clf()
