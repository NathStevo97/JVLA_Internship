...
for ANT_ID in ANT_LIST:
	...
	SPW0_Left = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW0_Left.txt", delimiter=",", unpack=True)
	SPW1_Left = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW1_Left.txt", delimiter=",", unpack=True)
	SPW2_Left = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW2_Left.txt", delimiter=",", unpack=True)
	SPW3_Left = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW3_Left.txt", delimiter=",", unpack=True)

	SPW0_Right = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW0_Right.txt", delimiter=",", unpack=True)
	SPW1_Right = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW1_Right.txt", delimiter=",", unpack=True)
	SPW2_Right = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW2_Right.txt", delimiter=",", unpack=True)
	SPW3_Right = np.loadtxt("/data/jvla/analysis/"+ANT_ID+"/SpW3_Right.txt", delimiter=",", unpack=True)
	...
	plt.savefig('/data/jvla/plots/Bandpass/'+ANT_ID+'_All_Pols.png', bbox_inches='tight')
	...
	plt.savefig('/data/jvla/plots/Bandpass/'+ANT_ID+'_Left.png', bbox_inches='tight')
	...
	plt.savefig('/data/jvla/plots/Bandpass/'+ANT_ID+'_Right', bbox_inches='tight')
	plt.clf()
	opacity = 0.8
	w = 1.0
	Left_SPWS = []
	...
	plt.savefig('/data/jvla/plots/Bandpass/'+ANT_ID+'_Percentage_Deviation_Comparison')
	plt.clf()
