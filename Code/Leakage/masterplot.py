...
#done so to check in case an SPW wasn't recorded
		root0_left="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW0/Left"
		root1_left="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW1/Left"
		root2_left="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW2/Left"
		root3_left="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW3/Left"
		...
		if filename in meas_list0_left: #repeat this one for each spw for both polarizations
			norm_data0_left = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW0/Left/"+fname+".txt", delimiter=",", unpack=True)
			for i in range(0,64):
		...
		if filename in meas_list1_left:
			norm_data1_left = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW1/Left/"+fname+".txt", delimiter=",", unpack=True)
		...
		if filename in meas_list2_left:
			norm_data2_left = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW2/Left/"+fname+".txt", delimiter=",", unpack=True)
		...
		if filename in meas_list3_left:
			norm_data3_left = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW3/Left/"+fname+".txt", delimiter=",", unpack=True)
...
#create list of directories for corresponding antenna and SPWS
#done so to check in case an SPW wasn't recorded
		root0_right="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW0/Right"
		root1_right="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW1/Right"
		root2_right="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW2/Right"
		root3_right="/data/jvla/analysis_leakage/"+ANT_ID+"/SpW3/Right"
		...
		if filename in meas_list0_right: #repeat this one for each spw for both polarizations
			norm_data0_right = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW0/Right/"+fname+".txt", delimiter=",", unpack=True)
			for i in range(0,64):
		...
		if filename in meas_list1_right:
			norm_data1_right = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW1/Right/"+fname+".txt", delimiter=",", unpack=True)
			for i in range(64,128):
		...
		if filename in meas_list2_right:
			norm_data2_right = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW2/Right/"+fname+".txt", delimiter=",", unpack=True)
			for i in range(128,192):
		...
		if filename in meas_list3_right:
			norm_data3_right = np.loadtxt("/data/jvla/analysis_leakage/"+ANT_ID+"/SpW3/Right/"+fname+".txt", delimiter=",", unpack=True)
			for i in range(192,256):
...
plt.savefig('/data/jvla/plots/Leakage/Masterplot.png')
